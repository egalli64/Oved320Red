...
<div class="row menu">
	<div class="col-sm">
		<a class='menu1' data-toggle="tooltip" title="Courses" href="courses.jsp">Courses</a>
	</div>
	<div class="col-sm">
		<a class='menu' data-toggle="tooltip" title="Instructors" href="instructors.jsp">Instructors</a>
	</div>
	<div class="col-sm">
